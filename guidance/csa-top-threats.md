...
- Security Issue 1: [Insufficient Identity, Credentials, Access, and Key Management](#security-issue-1-insufficient-identity-credentials-access-and-key-management)
- Security Issue 2: [Insecure Interfaces and APIs](#security-issue-2-insecure-interfaces-and-apis)
- Security Issue 3: [Misconfiguration and Inadequate Change Control](#security-issue-3-misconfiguration-and-inadequate-change-control)
- Security Issue 4: [Lack of Cloud Security Architecture and Strategy](#security-issue-4-lack-of-cloud-security-architecture-and-strategy)
- Security Issue 5: [Insecure Software Development](#security-issue-5-insecure-software-development)
- Security Issue 6: [Unsecured Third-Party Resources](#security-issue-6-unsecured-third-party-resources)
- Security Issue 7: [System Vulnerabilities](#security-issue-7-system-vulnerabilities)
- Security Issue 8: [Accidental Cloud Data Disclosure](#security-issue-8-accidental-cloud-data-disclosure)
- Security Issue 9: [Misconfiguration and Exploitation of Serverless and Container Workloads](#security-issue-9-misconfiguration-and-exploitation-of-serverless-and-container-workloads)
- Security Issue 10: [Organized Crime/Hackers/APT](#security-issue-10-organized-crime-hackers-apt)
- Security Issue 11: [Cloud Storage Data Exfiltration](#security-issue-11-cloud-storage-data-exfiltration)

==- Security Issue 1: Insufficient Identity, Credentials, Access, and Key Management
...
==- Security Issue 6: Unsecured Third-Party Resources
